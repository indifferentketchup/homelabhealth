 ...
 * @param {'overlay' | 'dock'} [props.variant='overlay'] — overlay: fixed layer; dock: flex column that pushes sibling content
 */
export function FileBrowserPanel({ isOpen, onClose, onFileSelect, rootPath, variant = 'overlay' }) {
