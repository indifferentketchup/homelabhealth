...
export const APP_TAGLINE = 'Your home. Your lab. Your health.'
/** Lucide icon name used as the hub glyph when no logo is present. */
export const APP_GLYPH = 'Stethoscope'
