...
import { FolderGit2, Terminal, User, Settings, Cpu, Sparkles } from 'lucide-react'
  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-4 py-10 md:px-8 md:py-14">
        ...
        >
          <div
            className="flex h-40 w-40 shrink-0 items-center justify-center overflow-hidden rounded-md border sm:h-52 sm:w-52"
            style={{
          ...
          >
            {logoFailed ? (
              <BoocodeGogglesFallback
                className="h-24 w-24"
                style={{ color: 'var(--orange)' }}
              />
            ) : (
              <img
                src={BOOCODE_LOGO_SRC}
                alt=""
          ...
          <div className="flex min-w-0 flex-1 flex-col gap-3 text-center sm:text-left">
            <h1
              className="boocode-display text-5xl md:text-6xl"
              style={{
                color: 'var(--orange)',
        ...
        <section className="flex flex-col gap-3">
          <div className="flex items-center gap-3">
            ...
            />
            <span
              className="text-[0.6875rem] uppercase tracking-[0.22em]"
          ...
          <div
            className="boocode-terminal-frame rounded-md px-6 py-10 text-center"
            style={{
          ...
          >
            ...
            <div className="mt-1 text-xs">DAW creation lands in Phase 3.</div>
          </div>
        </section>
